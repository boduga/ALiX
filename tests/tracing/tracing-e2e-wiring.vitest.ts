...
// ---------------------------------------------------------------------------
// vi.mock('langfuse') fake — same recording surface the adapter tests use. Every
// `new Langfuse(...)` the real LangfuseTraceClient performs is recorded; calling
// into the returned objects records trace/generation/span operations keyed by the
// ALiX runId (which the adapter uses as the Langfuse trace id).
// ---------------------------------------------------------------------------
