...
describe('PerTabState serializability', () => {
  it('round-trips through JSON without loss', () => {
    const original: PerTabState = {
      ...
      inputBuffer: '',
                pinnedBottom: true, submittedPrompts: [], agentResponses: [], pendingApprovals: [], resolvedApprovals: [], capabilityInvocations: [], panelScrollOffsets: { approvals: 0, sops: 0 }, panelFocus: null,
    };
