...
// Hermetic fixture: a temp project dir with a fast npm test script.
...
// any unit-test timeout. A controlled fixture keeps these tests fast and
// deterministic.
...
describe("VerificationPipeline", () => {
  it("discovers commands from the project", async () => {
    ...
    try {
      ...
      assert.ok(result.discovered.includes("test"), "should discover the npm test script");
