      ...
      signalSource: new FakeSignalSource([
        {
          ...
          consolidateDefinition: { id: "tool.file.read", version: "2.0.0", kind: "query", title: "consolidated", description: "d", tags: [], category: "tool", risk: "low", requiredPermissions: ["operator"], dependencies: [], bindings: [{ id: "tool.file.read", type: "native" }] },
