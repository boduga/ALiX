...
1. **Agent Loop**: Read src/task-classifier.ts - confirm it exports TaskType with: bugfix, feature, refactor, docs, research, unknown

2. **12 Providers**: Read src/providers/ directory listing - confirm these exist: anthropic-provider.ts, openai-provider.ts, gemini-provider.ts, mock-provider.ts, deepseek-provider.ts, groq-provider.ts, ollama-provider.ts, perplexity-provider.ts, minimax-provider.ts, zhipuai-provider.ts, grokai-provider.ts, openrouter-provider.ts
