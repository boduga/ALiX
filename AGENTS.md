...
This project is indexed by GitNexus as **ALiX** (8185 symbols, 15436 relationships, 209 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
