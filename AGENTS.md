...
This project is indexed by GitNexus as **ALiX** (42418 symbols, 76128 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
