 ...
 *
 * @module evolution/a9/correlations-adapter
 */

import type { A9Correlation } from "./contracts/a9-contract.js";
...
export class CorrelationsAdapter {
   ...
   */
  async byForecast(forecastId: string): Promise<ReadonlyArray<A9Correlation>> {
   ...
   * measurement M".
   */
  async byMeasurement(measurementId: string): Promise<ReadonlyArray<A9Correlation>> {
