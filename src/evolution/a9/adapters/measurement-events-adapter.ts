 ...
 *
 * @module evolution/a9/adapters/measurement-events-adapter
 */
...
export const A9_MEASUREMENT_EVENT_TYPE = "capability.governance.measurement.measured";
...
export class MeasurementEventsAdapter implements A9Adapter<CapabilityMeasurementRecord> {
  ...
  async list(): Promise<ReadonlyArray<CapabilityMeasurementRecord>> {
    ...
    return all
      .filter((e) => e.type === A9_MEASUREMENT_EVENT_TYPE)
