 ...
 *
 * Pure function that constructs ONE `A9Correlation` for a qualifying
 ...
 * The A9Correlation contract carries no timestamp field, so it is NOT
 ...
 *
 * @module evolution/a9/correlation-builder
 */
...
import { A9_CORRELATION_VERSION } from "./contracts/a9-contract.js";
 ...
 */
function computeDelta(observed: RiskBand, forecastBand: RiskBand): A9Correlation["resolution"]["delta"] {
...
export function buildCorrelation(
  ...
  // A9Correlation contract has no timestamp field, and identity must not
