 ...
 *
 * Flow:
 *   raw adapters → detectors → A9Forecast → forecast JSONL (append-only)
 ...
 *   The A9Forecast contract carries no source-unavailable field, so the
 ...
 *
 * @module evolution/a9/forecast-cli
 */
