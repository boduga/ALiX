 ...
 *
 * Adapts an `A9Forecast` into an A2.5 `GovernanceRecommendation` so the
 ...
 *
 * ---------------------------------------------------------------------------
 * Field-shape adaptation (mirrors the A8 bridge, src/evolution/learning/a2-bridge.ts)
 * ---------------------------------------------------------------------------
 *
 ...
 * diverge.
 */
function hashEvidenceRefs(forecast: A9Forecast): string {
