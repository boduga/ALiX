 ...
 *
 * Implements the `Measurement` seam (`src/capability/measurement/measurement-contract.ts`).
 ...
 *
 * @module evolution/observation/capability-measurement
 */
...
import type {
  Measurement,
  MeasurementTarget,
} from "../../capability/measurement/measurement-contract.js";
import type { CapabilityCatalog } from "../../capability/canonical/catalog.js";
import type { ProposalSignalSink, CapabilityEvolutionSignal } from "../../capability/evolution/proposals.js";
...
export interface CapabilityMeasurementOptions {
...
export class CapabilityMeasurement implements Measurement {
  ...
  constructor(options: CapabilityMeasurementOptions) {
  ...
  private resolveProviderName(target: MeasurementTarget): string {
