 ...
 *
 * @module evolution/forecast/forecast-engine
 */
...
export interface ForecastEngineAdapters {
  ...
  readonly enrichedProposals: ForecastAdapter<EnrichedProposalRecord>;
}
...
export class ForecastEngine {
   ...
   */
  async forecast(now: string): Promise<ReadonlyArray<Forecast>> {
