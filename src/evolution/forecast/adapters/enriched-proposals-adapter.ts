 ...
 *
 * @module evolution/forecast/adapters/enriched-proposals-adapter
 */

import type { EnrichedProposal } from "../../../adaptation/intelligence-types.js";
import type { ForecastAdapter, EnrichedProposalRecord } from "../contracts/contract.js";
...
export class EnrichedProposalsAdapter implements ForecastAdapter<EnrichedProposalRecord> {
