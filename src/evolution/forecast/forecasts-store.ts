 ...
 *
 * Append-only JSONL persistence for Forecast artifacts.
 *
 ...
 *
 * @module evolution/forecast/forecasts-store
 */
...
export class ForecastsStore extends JsonlStore<Forecast, ForecastId> {
 ...
 * false collision).
 */
export function forecastContentOf(forecast: Forecast): string {
