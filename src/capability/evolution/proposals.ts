 ...
 *
 * @module capability/evolution/proposals
 */
...
export interface CapabilityProposalGeneratorOptions {
 ...
 */
export class CapabilityProposalGenerator {
  private readonly signalSource: ProposalSignalSource;

  constructor(options: CapabilityProposalGeneratorOptions) {
 ...
 * touch this factory.
 */
export function defaultCapabilityProposalGenerator(): CapabilityProposalGenerator {
  ...
  void _unwiredSeam;
  throw new Error(
    "defaultCapabilityProposalGenerator() is a composition-root placeholder — wire the real P5.5/P5.6 signal source explicitly",
  );
}
