...
- Workbench composer input and backspace operate on complete Unicode graphemes; its cursor remains a JavaScript string offset positioned at a grapheme boundary.
