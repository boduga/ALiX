...
export function paintWorkbenchDiagnosticOverlay(
  ...
  const lines = overlay === 'help'
    ? ['Enter submit / queue', 'Shift+Enter newline', 'Esc close / cancel', 'Ctrl+A agents · Ctrl+T tasks', 'Ctrl+O details · Shift+Tab permission', '/agents · /tasks · /artifacts · /diff · /review · /help']
    : [
