...
### 2.3 Learning, not Recommendation
...
## 6. Drift Outcome Correlation Analytics (P27.2)

### 6.1 Analytics Functions
...
| Repeated drift patterns | Signals with same kind appearing across multiple windows |
...
| Missing outcome detection | Terminal candidates lacking any outcome record |

### 6.2 Prohibited Analytics
...
## 7. Review Learning Synthesis Report (P27.3)

### 7.1 Report Semantics
